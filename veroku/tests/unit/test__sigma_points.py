...
class TestSigmaPoints(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.sps_a_cov = np.array([[4.0, 1.0, 0.5],
                                   [1.0, 3.3, 0.1],
                                   [0.5, 0.1, 6.5]])
        self.sps_a_mean = np.array([[4.0],
                                    [5.0],
                                    [8.0]])
        self.sps_a_array = np.array([[0.25834261322605867, 4.0000000000000000, 4.0000000000000000, 4.0000000000000000,
                                      7.741657386773941, 4.000000000000000, 4.0000000000000000],
                                     [4.06458565330651500, 1.7327381494590917, 5.0000000000000000, 5.0000000000000000,
                                      5.935414346693485, 8.267261850540908, 5.0000000000000000],
                                     [7.53229282665325700, 8.0267808348405000, 3.2533661625436867, 8.0000000000000000,
                                      8.467707173346742, 7.973219165159501, 12.746633837456313]])
    ...
    def test_sigma_points_to_gaussian_params(self):
        ...
        when(_sigma_points).sigma_point_array_to_gaussian_params(...).thenReturn((self.sps_a_cov, self.sps_a_mean))
