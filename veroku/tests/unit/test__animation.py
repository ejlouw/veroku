...
class TestAnimation(unittest.TestCase):
    ...
    def test_contains_non_overlapping_substrings(self):
        ...
        self.assertTrue(contains_non_overlapping_substrings(substring_a='abc', substring_b='def', string='abcdef'))
        self.assertTrue(contains_non_overlapping_substrings(substring_a='def', substring_b='abc', string='abcdef'))

        self.assertFalse(contains_non_overlapping_substrings(substring_a='abc', substring_b='cde', string='abcdef'))
        self.assertFalse(contains_non_overlapping_substrings(substring_a='cde', substring_b='abc', string='abcdef'))

        self.assertFalse(contains_non_overlapping_substrings(substring_a='abc', substring_b='ab', string='abcdef'))
        self.assertFalse(contains_non_overlapping_substrings(substring_a='ab', substring_b='abc', string='abcdef'))

        self.assertFalse(contains_non_overlapping_substrings(substring_a='ab', substring_b='abc', string='bcdef'))
        self.assertFalse(contains_non_overlapping_substrings(substring_a='abc', substring_b='ab', string='bcdef'))

        self.assertFalse(contains_non_overlapping_substrings(substring_a='abc', substring_b='def', string='bcdef'))

        self.assertTrue(contains_non_overlapping_substrings(substring_a='_ssb_', substring_b='ssb', string='_ssb_ssb'))
